...
import {removeUndefined, aitdTimeToISO8601} from '../../common'
 ...
 * @throws RangeError: Invalid time value (aitdTimeToISO8601)
 */
    ...
    Object.assign(
      {
        ...
        closeTime: aitdTimeToISO8601(ledger.close_time),
        closeTimeResolution: ledger.close_time_resolution,
        closeFlags: ledger.close_flags,
        ledgerHash: ledger.hash || ledger.ledger_hash,
        ledgerVersion: ledgerVersion,
        parentLedgerHash: ledger.parent_hash,
        parentCloseTime: aitdTimeToISO8601(ledger.parent_close_time),
