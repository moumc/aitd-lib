...
export type FormattedAccountDelete = {
  // account (address) of an account to receive any leftover AITD after deleting the sending account.
  ...
  // for the recipient of the deleted account's leftover AITD. NB: Ensure that the hosted recipient is
  // able to account for AccountDelete transactions; if not, your balance may not be properly credited.
  destinationTag?: number

  // X-address of an account to receive any leftover AITD after deleting the sending account.
  // Must be a funded account in the ledger, and must not be the sending account.
