...
import {parseTimestamp, adjustQualityForAITD} from './utils'
...
// TODO: remove this function once aitdd provides quality directly
...
// aitdd 'account_offers' returns a different format for orders than 'tx'
...
export function parseAccountOrder(
  ...
  const specification = removeUndefined({
    ...
    // aitdd currently does not provide "expiration" in account_offers
