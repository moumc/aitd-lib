...
function getAITDBalance(
  ...
  return connection
    .request(request)
    .then((data) => common.dropsToAitd(data.account_data.Balance))
}
...
/**
 *  Order two aitdd transactions based on their ledger_index.
 *  If two transactions took place in the same ledger, sort
 *  them based on TransactionIndex
 *  See: https://developers.aitd.com/transaction-metadata.html
 */
...
function ensureLedgerVersion(this: AitdAPI, options: any): Promise<object> {
  if (
    Boolean(options) &&
