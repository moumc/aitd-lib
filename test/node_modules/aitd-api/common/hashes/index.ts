 ...
 *
 * See [Serialization Format](https://aitdl.org/serialization.html)
 *
 ...
 * ID is unique.
 *
 * See [Ledger Object IDs](https://aitdl.org/ledger-object-ids.html)
 *
...
/**
 * [SignerList ID Format](https://aitdl.org/signerlist.html#signerlist-id-format)
 *
 * The ID of a SignerList object is the SHA-512Half of the following values, concatenated in order:
 *   * The AitdState space key (0x0053)
...
/**
 * [Offer ID Format](https://aitdl.org/offer.html#offer-id-format)
 *
...
export const computeTrustlineHash = (
  ...
  const prefix = ledgerSpaceHex('aitdState')
  return sha512Half(
