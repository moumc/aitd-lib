...
/**
 * Expects a corresponding ledger dump in $repo/test/fixtures/aitdd folder
 */
function createLedgerTest(ledgerIndex: number) {
  describe(String(ledgerIndex), function () {
    var path =
      __dirname + '/fixtures/aitdd/ledger-full-' + ledgerIndex + '.json'
...
describe('Ledger', function () {
  ...
  describe('calcAitdStateEntryHash', function () {
    it('will calculate the AitdState entry hash for rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh and rB5TihdPbKgMrkFqrqUC3yLdE8hhv4BdeY in USD', function () {
    ...
    it('will calculate the AitdState entry hash for r3kmLJN5D28dHuH8vZNUZpMC43pEHpaocV and rUAMuQTfVhbfqUDuro7zzy4jj4Wq57MPTj in UAM', function () {
