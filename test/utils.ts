...
/**
 * The test function. It takes a AitdAPI object and then some other data to
...
export function getAllPublicMethods(api: AitdAPI) {
  return Array.from(
    new Set([
      ...Object.getOwnPropertyNames(api),
      ...Object.getOwnPropertyNames(AitdAPI.prototype)
    ])
