...
module.exports = {
  ...
  preparePayment: {
    ...
    minAmountAITD: require('./prepare-payment-min-aitd'),
  ...
  getPaths: {
    ...
    AitdToAitd: require('./getpaths/aitd2aitd'),
    AitdToAitdNotEnough: require('./getpaths/aitd2aitd-not-enough'),
  ...
  getOrderbook: {
    ...
    withAITD: require('./get-orderbook-with-aitd')
  },
  computeLedgerHash: {
